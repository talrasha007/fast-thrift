...
TBinaryProtocol.prototype.writeI16 = function(i16) {
  this.trans.write(binary.writeI16(this._buffer, i16), 2);
}

TBinaryProtocol.prototype.writeI32 = function(i32) {
  this.trans.write(binary.writeI32(this._buffer, i32), 4);
}

TBinaryProtocol.prototype.writeI64 = function(i64) {
  if (i64.low !== undefined && i64.high !== undefined) {
    this.writeI32(i64.high);
    this.writeI32(i64.low);
  } else {
    switch (typeof i64) {
      case 'number':
...
TBinaryProtocol.prototype.writeDouble = function(dub) {
  this.trans.write(binary.writeDouble(this._buffer, dub), 8);
}
