...
TBinaryProtocol.prototype.writeByte = function(byte) {
  this._buffer[0] = byte;
  this.trans.write(this._buffer, 1);
}

TBinaryProtocol.prototype.writeI16 = function(i16) {
  this._buffer.writeInt16BE(i16, 0);
  this.trans.write(this._buffer, 2);
}

TBinaryProtocol.prototype.writeI32 = function(i32) {
  this._buffer.writeInt32BE(i32, 0);
  this.trans.write(this._buffer, 4);
}

TBinaryProtocol.prototype.writeI64 = function(i64) {
  if (i64.low !== undefined && i64.high !== undefined) {
    this._buffer.writeInt32BE(i64.high, 0);
    this._buffer.writeInt32BE(i64.low, 4);
    this.trans.write(this._buffer, 8);
  } else {
    switch (typeof i64) {
      case 'number':
        this.writeI64(Int64.fromInt(i64));
        break;
      case 'string':
        this.writeI64(Int64.fromString(i64));
        break;
      default:
        this.writeI64(Int64.fromString(i64.toString()));
    }
  }
}

TBinaryProtocol.prototype.writeDouble = function(dub) {
  this._buffer.writeDoubleBE(dub, 0);
  this.trans.write(this._buffer, 8);
}

TBinaryProtocol.prototype.writeString = function(arg) {
  if (typeof(arg) === 'string') {
    var len = Buffer.byteLength(arg, 'utf8');
    this.writeI32(len);
    this.trans.write(arg, len);
...
TBinaryProtocol.prototype.readI64 = function() {
  var high = this.trans.readI32(),
      low = this.trans.readI32();
